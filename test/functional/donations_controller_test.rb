...
class DonationsControllerTest < ActionController::TestCase
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post :create, donation: { amount: @donation.amount, body: @donation.body, picture: @donation.picture, title: @donation.title, video: @donation.video }
    end
  ...
  test "should update donation" do
    put :update, id: @donation, donation: { amount: @donation.amount, body: @donation.body, picture: @donation.picture, title: @donation.title, video: @donation.video }
    assert_redirected_to donation_path(assigns(:donation))
  end
